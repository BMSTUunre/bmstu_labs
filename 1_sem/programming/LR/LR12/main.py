...
texts = [
    [
        ...
        'что его тоже нужно побл7-1агодарить. Настала 0-0 1 - 2 тишина. Никто ',
        'не торопился поддержать предложение Чэн Синь. Для большинства',
        'собравшихся Уэйд олицетворял все темные стороны, присущие',
        'характеру людей Общей 3/2 Эры. Он был полной противоположностью',
...
def main():
    while True:
        ...
        if not n or n == '0':
            ...
            break
        cur_matrix = funcs_list(n, cur_matrix)
